...
Gui, Add, Text, x10 y10 w350 h50, Important: Make sure to put this command in console.
Gui, Font, 626152 
...
Gui, Add, Text, x80 y150 w300 h60 c181815, hold mouse4 while ingame to activate
Gui, Font, s10 Bold cFF0000 
Gui, Add, Text, x290 y9 w120 h50 c181815, Made By Lunar
Gui, Font, s12 Bold
Gui, Color, ACAA90 ; Background color
Gui, Margin, 10, 10
Gui, Show, Center,  Lunar CS2 Bhop Script
